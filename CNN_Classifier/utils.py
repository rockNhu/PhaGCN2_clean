# Order dict
order_dict = {0: "Bunyavirales", 1: "Mononegavirales", 2: "Nidovirales",
              3: "Ortervirales", 4: "Picornavirales", 5: "Tymovirales"}

# Family dict
Bunyavirales_dict = {0: "Arenaviridae", 1: "Fimoviridae",
                     2: "Peribunyaviridae", 3: "Phenuiviridae", 4: "Tospoviridae"}

Mononegavirales_dict = {1: "Bornaviridae", 2: "Filoviridae",
                        3: "Paramyxoviridae", 4: "Rhabdoviridae"}

Nidovirales_dict = {1: "Arteriviridae", 2: "Coronaviridae",
                    3: "Mesoniviridae", 4: "Tobaniviridae"}

Ortervirales_dict = {1: "Caulimoviridae", 2: "Retroviridae"}

Picornavirales_dict = {1: "Dicistroviridae", 2: "Iflaviridae",
                       3: "Marnaviridae", 4: "Picornaviridae", 5: "Secoviridae"}

Tymovirales_dict = {1: "Alphaflexiviridae",
                    2: "Betaflexiviridae", 3: "Tymoviridae"}
...
Paramyxoviridae_dict = {1: "Henipavirus", 2: "Jeilongvirus",
                        3: "Morbillibirus", 4: "Pararubulavirus", 5: "Respirovirus"}

Rhabdoviridae_dict = {1: "Hapavirus", 2: "Ledantevirus",
                      3: "Lyssavirus", 4: "Vesivulovirus"}

Coronaviridae_dict = {1: "Betacoronavirus", 2: "Deltacoronavirus"}

Caulimoviridae_dict = {1: "Badnavirus", 2: "Caulimovirus", 3: "Cavemovirus"}

Retroviridae_dict = {1: "Alpharetrovirus", 2: "Deltaretrovirus",
                     3: "Epsilonretrovirus", 4: "Gammaretrovirus", 5: "Lentivirus", 6: "Simiispumavirus"}

Dicistroviridae_dict = {1: "Aparavirus", 2: "Cripavirus"}

Picornaviridae_dict = {1: "Cosavirus", 2: "Enterovirus",
                       3: "Hepatovirus", 4: "Kobuvirus", 5: "Parechovirus"}

Secoviridae_dict = {1: "Cheravirus", 2: "Comovirus",
                    3: "Fabavirus", 4: "Nepovirus", 5: "Torradovirus"}

Alphaflexiviridae_dict = {1: "Allexivirus", 2: "Potexvirus"}

Betaflexiviridae_dict = {1: "Capillovirus", 2: "Carlavirus", 3: "Divavirus",
                         4: "Foveavirus", 5: "Robigovirus", 6: "Trichovirus", 7: "Virivirus"}
...
def get_leaf_num(name):
    ...
    if name == "Betaflexiviridae":
        return 7
    return 2 if name == "Tymoviridae" else 0
